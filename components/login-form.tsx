...
export function LoginForm({
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // run validation and short-circuit
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid gap-6">
              ...
              <div className="grid gap-6">
                ...
                <div className="grid gap-2">
                  <div className="flex items-center">
                    ...
                    <a href={forgotHref} className="ml-auto text-sm underline-offset-4 hover:underline">Forgot your password?</a>
                  </div>
              ...
              <div className="text-center text-sm">
                Don&apos;t have an account? <Link href={signUpHref} className="underline underline-offset-4">Sign up</Link>
              </div>
            </div>
          </form>
        </CardContent>
