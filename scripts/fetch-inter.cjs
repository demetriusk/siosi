...
// This script downloads Inter from GitHub release (a zip archive of ttf files)
...
const urls = [
  ...
  'https://github.com/rsms/inter/releases/download/v3.20/Inter-3.20.zip',
  'https://github.com/rsms/inter/releases/latest/download/Inter-latest.zip'
];
